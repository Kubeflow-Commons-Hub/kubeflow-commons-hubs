...
export function PlatformBanner() {
  return (
    <section className="py-16 md:py-24 bg-bg-primary">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <span className="inline-block text-xs font-semibold uppercase tracking-widest text-[var(--kf-blue)] mb-4">
          New to Kubeflow?
        </span>
